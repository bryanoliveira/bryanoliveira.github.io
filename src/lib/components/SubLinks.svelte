<div id="sub-links" class="lead mt-1">
    <a href="https://scholar.google.com/citations?user=f2yQCZsAAAAJ&hl=en" target="_blank" title="Google Scholar">
    ...
    <a href="https://github.com/bryanoliveira" target="_blank" title="Github">
    ...
    <a href="https://twitter.com/bryanlmoliveira" target="_blank" title="Twitter">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
            <path
    ...
    <a href="mailto:bryanlmoliveira@gmail.com" target="_blank" title="E-mail me!">
